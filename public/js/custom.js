...
$(".image-upload").on('click', 'i', function () {
  ...
  $(this).parents('.image-upload').children('img').attr('src', 'http://localhost/laravel/adulusbuy/public/assets/admin/images/placeholder.png');
  $(this).remove();
});
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\laravelecommerce\resources\js\admin\custom.js */"./resources/js/admin/custom.js");
