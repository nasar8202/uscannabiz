	                           ...
	                           <div class="dokan-w6 dokan-dash-left">
	                              ...
	                              <div class="dashboard-widget orders">
	                                 ...
	                                 <div class="content-half-part">
	                                    <ul class="list-unstyled list-count">
	                                       <li>
	                                          <a href="orders/">
	                                          <span class="title">Total</span> <span class="count">0</span>
	                                          </a>
	                                       </li>
	                                       <li>
	                              ...
	                              <div class="dashboard-widget products">
	                                 ...
	                                 <ul class="list-unstyled list-count">
	                                    <li>
	                                       <a href="products/">
	                                       <span class="title">Total</span> <span class="count">7</span>
	                                       </a>
	                                    </li>
	                                    <li>
